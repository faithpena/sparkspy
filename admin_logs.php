...
<head>
  ...
  <title>View Logs</title> <!--Change this -->
    ...
    <div class = "row display-table-row">
      <div class = "col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id = "sidebar">
        <div class = "navi">
          <ul>
            ...
            <li><a class = "active" href="admin_logs.php"><span class = "hidden-xs hidden-sm">View Logs</span></a></li>
      ...
      <div class = "col-md-10 col-sm-11 v-align box">
        <div class = "labels text-center">
          <legend>Security Logs</legend>
        </div>
        <div class = "text-center">
          <ul>
            <li><span class = "roomList">No logs to display.</span>
          </ul>
        </div>
      </div>
    </div>
